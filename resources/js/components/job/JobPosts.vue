        ...
        <transition-group name="list-down">
            <li class="job-items" v-for="(post, index) in jobPosts" :key="index+0" v-if="post.company">
                <div class="profile-content" style="padding-bottom: 10px;">
                    ...
                    <a class="job-wrapper" :href="`/job/view?` + `cid=${post.company_id}&jid=${post.id}&v=details`">
                        ...
                        <div class="job-summary">
                            <div>
                                <label :class="{'text-success': post.status == 1 || post.status == 2, 'text-danger': !post.status }">
                                    {{ post.status == 2 ? 'Filled' : 'Active'}}
                                </label>
                            </div>
                            ...
                            <div class="bl-label-15 bl-mt16" v-html="post.description.replace(/(?:\r\n|\r|\n)/g, '<br />')">
                    ...
                    <div class="row mt-3 stats-wrapper">
                        ...
                        <div class="col-md-2 col-sm-2" v-show="userType != 'worker'">
